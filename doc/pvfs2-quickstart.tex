...
require writing a few files in the kernel source directory to build a module,
you may have to become root to compile the kernel module.  To build the module,
type ``make kmod''.
...
kernel.  You can then verify that the module was loaded properly using
'lsmod' as follows:
...
\begin{verbatim}
gil:~# mount -t pvfs2 tcp://testhost:3334/pvfs2-fs /mnt/pvfs2
gil:~# mount
