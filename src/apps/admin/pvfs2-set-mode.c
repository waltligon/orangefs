    ...
    char **argv)
{
    ...
    ret = PVFS_mgmt_setparam_all(cur_fs,
                                 &creds, PVFS_SERV_PARAM_MODE, user_opts->mode,
                                 NULL, NULL /* detailed errors */ );
...
{
    fprintf(stderr, "\n");
    fprintf(stderr, "Usage  : %s [-m fs_mount_point] <mode>\n", argv[0]);
    fprintf(stderr, "Example: %s -m /mnt/pvfs2 \"normal\"\n", argv[0]);
