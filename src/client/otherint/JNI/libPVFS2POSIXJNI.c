...
/* Include flag helper */
#include "flags/posix_flag_conv.h"
...
)
{
    ...
    int cflags_len = (*env)->GetStringLength(env, flags);
    char cflags[cflags_len + 1];
    (*env)->GetStringUTFRegion(env, flags, 0, cflags_len, cflags);
    /* Finally Convert to int representation */
    int int_flags = (int) posix_fsti(cflags);
    ...
    mode_t mode_mode = (mode_t) posix_fsti(cmode);

    if((int_flags & O_CREAT) == O_CREAT)
    {
        if(JNI_DBG) printf("\tO_CREAT detected!\n");
        rc = jni_open(cpath, int_flags, mode_mode);
    }
    else
    {
        if(JNI_DBG) printf("\tNo O_CREAT detected\n");
        rc = jni_open(cpath, int_flags);
    }
    if(rc < 0)
    {
...
JNIEXPORT int JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_open64 (JNIEnv *env, jobject obj, jstring path, jstring flags)
{
    PFI
    int rc = 0;
...
Java_org_orangefs_usrint_PVFS2POSIXJNI_openat (JNIEnv *env, jobject obj, int dirfd, jstring path, jstring flags)
{
    PFI
    int rc = 0;
    ...
    rc = jni_openat(dirfd, cpath, int_flags);
    if(rc < 0)
    {
...
/* jni_openat64 */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_openat64 (JNIEnv *env, jobject obj, int dirfd, jstring path, jstring flags)
{
    PFI
    int rc = 0;
...
/* jni_creat */
JNIEXPORT int JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_creat(JNIEnv *env, jobject obj, jstring path, jstring mode)
{
    PFI
    int rc = 0;
...
/* jni_creat64 */
JNIEXPORT int JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_creat64(JNIEnv *env, jobject obj, jstring path, jstring mode)
{
    PFI
    int rc = 0;
    ...
    rc = jni_creat64(cpath, mode_mode);
    if(rc < 0)
    {
        perror("jni_creat error");
        rc = -1;
...
/* jni_unlinkat */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_unlinkat (JNIEnv *env, jobject obj, int dirfd, jstring path, jstring flags)
{
    PFI
    int rc = 0;
    ...
    rc = jni_unlinkat(dirfd, cpath, int_flags);
    if(rc < 0)
    {
...
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_prdwr64(JNIEnv *env, jobject obj, int fd, jlong buf, jlong count, jlong offset, int which)
{
    PFI
    ...
    void* bufc = (void*) buf;
    int rc = 0;
    rc = jni_prdwr64(fd, bufc, countc, offsetc, which);
    if(rc < 0)
    {
...
Java_org_orangefs_usrint_PVFS2POSIXJNI_lseek(JNIEnv *env, jobject obj, int fd, jlong offset, jstring whence)
{
    PFI
    ...
    off_t rc = jni_lseek(fd, offsetc, int_whence);
    jlong op = (jlong)rc;
    if(op < 0)
    {
...
/* jni_lseek64 */
JNIEXPORT jlong JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_lseek64(JNIEnv *env, jobject obj, int fd, jlong offset, jstring whence)
{
    PFI
    off_t offsetc = (off_t) offset;
...
/* jni_fchownat */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fchownat(JNIEnv *env, jobject obj, int fd, jstring path, jlong owner, jlong group, jstring flag)
{
    PFI
    char cpath[PVFS_PATH_MAX];
    int cpath_len = (*env)->GetStringLength(env, path);
    ...
    int cflag_len = (*env)->GetStringLength(env, flag);
    char cflag[cflag_len + 1];
    (*env)->GetStringUTFRegion(env, flag, 0, cflag_len, cflag);
    /* Finally Convert to int representation */
    int int_flag = (int) posix_fsti(cflag);

    int rc = jni_fchownat(fd, cpath, cowner, cgroup, int_flag);
    if(rc < 0)
    {
...
/* jni_chmod */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_chmod(JNIEnv *env, jobject obj, jstring path, jstring mode)
{
    PFI
    ...
    int rc = jni_chmod(cpath, mode_mode);
    if(rc < 0)
    {
...
/* jni_fchmod */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fchmod(JNIEnv *env, jobject obj, int fd, jstring mode)
{
    PFI
    ...
    int rc = jni_fchmod(fd, mode_mode);
    if(rc < 0)
    {
...
/* jni_fchmodat */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fchmodat (JNIEnv *env, jobject obj, int fd, jstring path, jstring mode, jstring flag)
{
    PFI
    int cpath_len = (*env)->GetStringLength(env, path);
    char cpath[cpath_len + 1];
    ...
    int rc = jni_fchmodat(fd, cpath, mode_mode, int_flag);
    if(rc < 0)
    {
...
/* jni_mkdir */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_mkdir (JNIEnv *env, jobject obj, jstring path, jstring mode)
{
    PFI
    int rc = 0;
...
/* jni_mkdirat */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_mkdirat (JNIEnv *env, jobject obj, int dirfd, jstring path, jstring mode)
{
    PFI
    int rc = 0;
    ...
    rc = jni_mkdirat(dirfd, cpath, mode_mode);
    if(rc < 0)
    {
...
/* jni_linkat */
JNIEXPORT int JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_linkat(JNIEnv *env, jobject obj, int olddirfd, jstring oldpath, int newdirfd, jstring newpath, jstring flags)
{
    PFI
    int rc = 0;
    char coldpath[PVFS_PATH_MAX];
    ...
    rc = jni_linkat(olddirfd, coldpath, newdirfd, cnewpath, int_flags);
    if(rc < 0)
    {
...
/* jni_access */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_access (JNIEnv *env, jobject obj, jstring path, jstring mode)
{
    PFI
    ...
    int rc = jni_access(cpath, mode_mode);
    if(rc < 0)
    {
...
/* jni_faccessat */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_faccessat (JNIEnv *env, jobject obj, int fd, jstring path, jstring mode, jstring flags)
{
    PFI
    ...
    int rc = jni_faccessat(fd, cpath, mode_mode, int_flags);
    if(rc < 0)
    {
...
/* jni_flock */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_flock (JNIEnv *env, jobject obj, int fd, jstring op)
{
    PFI

    int cop_len = (*env)->GetStringLength(env, op);
    char cop[cop_len + 1];
    (*env)->GetStringUTFRegion(env, op, 0, cop_len, cop);
    /* Finally Convert to int representation */
    int int_op = (int) posix_fsti(cop);

    int rc = jni_flock(fd, int_op);
    if(rc < 0)
    {
...
/* jni_fcntl */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fcntl  (JNIEnv *env, jobject obj, int fd, jstring cmd)
{
    PFI
...
/* jni_fadvise */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fadvise  (JNIEnv *env, jobject obj, int fd, jlong offset, jlong len, jstring advice)
{
    PFI

    int cadvice_len = (*env)->GetStringLength(env, advice);
    char cadvice[cadvice_len + 1];
    (*env)->GetStringUTFRegion(env, advice, 0, cadvice_len, cadvice);
    /* Finally Convert to int representation */
    int int_advice = (int) posix_fsti(cadvice);

    int rc = jni_fadvise(fd, (off_t) offset, (off_t) len, int_advice);
    if(rc < 0)
    {
...
/* jni_fadvise64 */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fadvise64  (JNIEnv *env, jobject obj, int fd, jlong offset, jlong len, jstring advice)
{
    PFI
    ...
    int rc = jni_fadvise64(fd, (off_t) offset, (off_t) len, int_advice);
    if(rc < 0)
    {
...
/* jni_mknod */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_mknod  (JNIEnv *env, jobject obj, jstring path, jstring mode, int dev)
{
    PFI
    ...
    int rc = jni_mknod(cpath, mode_mode, cdev);
    if(rc < 0)
    {
...
/* jni_mknodat */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_mknodat (JNIEnv *env, jobject obj, int dirfd, jstring path, jstring mode, int dev)
{
    PFI
    ...
    dev_t cdev = (dev_t) dev;
    int rc = jni_mknodat(dirfd, cpath, mode_mode, cdev);
    if(rc < 0)
    {
...
/* jni_umask */
JNIEXPORT jint JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_umask  (JNIEnv *env, jobject obj, jstring mask)
{
    PFI

    int cmask_len = (*env)->GetStringLength(env, mask);
    char cmask[cmask_len + 1];
    (*env)->GetStringUTFRegion(env, mask, 0, cmask_len, cmask);
    /* Finally Convert to mode_t representation */
    mode_t mode_mask = (mode_t) posix_fsti(cmask);

    mode_t rc = jni_umask(mode_mask);
    if(rc < 0)
    {
...
/* jni_fstatat */
JNIEXPORT jobject JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fstatat(JNIEnv *env, jobject obj, int fd, jstring path, jstring flag)
{
    PFI
    struct stat *ptr = 0;
    ...
    int rc = jni_fstatat(fd, cpath, ptr, int_flag);
    if(rc < 0)
    {
...
/* jni_Fstatat64 */
JNIEXPORT jobject JNICALL
Java_org_orangefs_usrint_PVFS2POSIXJNI_fstatat64(JNIEnv *env, jobject obj, int fd, jstring path, jstring flag)
{
    PFI
    struct stat64 *ptr = 0;
    ...
    int rc = jni_fstatat64(fd, cpath, ptr, int_flag);
    if(rc < 0)
    {
