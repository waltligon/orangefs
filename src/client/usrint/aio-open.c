...
static struct PINT_state_s ST_pdir_given;
static struct PINT_pjmp_tbl_s ST_pdir_given_pjtbl[];
static struct PINT_tran_tbl_s ST_pdir_given_trtbl[];

static PINT_sm_action open_pdir_lookup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_pdir_lookup;
static struct PINT_pjmp_tbl_s ST_pdir_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_pdir_lookup_trtbl[];
static struct PINT_state_s ST_pdir_ref_lookup_rel;
static struct PINT_pjmp_tbl_s ST_pdir_ref_lookup_rel_pjtbl[];
static struct PINT_tran_tbl_s ST_pdir_ref_lookup_rel_trtbl[];
static struct PINT_state_s ST_pdir_ref_lookup_abs;
static struct PINT_pjmp_tbl_s ST_pdir_ref_lookup_abs_pjtbl[];
static struct PINT_tran_tbl_s ST_pdir_ref_lookup_abs_trtbl[];

static PINT_sm_action open_pdir_ref_lookup_rel_setup_next(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_pdir_ref_lookup_rel_setup_next;
static struct PINT_pjmp_tbl_s ST_pdir_ref_lookup_rel_setup_next_pjtbl[];
static struct PINT_tran_tbl_s ST_pdir_ref_lookup_rel_setup_next_trtbl[];

static PINT_sm_action open_pdir_ref_lookup_abs_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_pdir_ref_lookup_abs_inspect;
static struct PINT_pjmp_tbl_s ST_pdir_ref_lookup_abs_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_pdir_ref_lookup_abs_inspect_trtbl[];

static PINT_sm_action open_resolve_fail_file_lookup_abs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_resolve_fail_file_lookup_setup;
static struct PINT_pjmp_tbl_s ST_resolve_fail_file_lookup_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_resolve_fail_file_lookup_setup_trtbl[];
static struct PINT_state_s ST_resolve_fail_file_lookup;
static struct PINT_pjmp_tbl_s ST_resolve_fail_file_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_resolve_fail_file_lookup_trtbl[];

static PINT_sm_action open_resolve_fail_file_lookup_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_resolve_fail_file_lookup_inspect;
static struct PINT_pjmp_tbl_s ST_resolve_fail_file_lookup_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_resolve_fail_file_lookup_inspect_trtbl[];

static PINT_sm_action open_file_lookup_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_file_lookup_setup;
static struct PINT_pjmp_tbl_s ST_file_lookup_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_file_lookup_setup_trtbl[];
static struct PINT_state_s ST_file_lookup;
static struct PINT_pjmp_tbl_s ST_file_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_file_lookup_trtbl[];

static PINT_sm_action open_file_lookup_setup_next(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_file_lookup_setup_next;
static struct PINT_pjmp_tbl_s ST_file_lookup_setup_next_pjtbl[];
static struct PINT_tran_tbl_s ST_file_lookup_setup_next_trtbl[];

static PINT_sm_action open_file_ref_lookup_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_file_lookup_inspect;
static struct PINT_pjmp_tbl_s ST_file_lookup_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_file_lookup_inspect_trtbl[];
static struct PINT_state_s ST_create_file;
static struct PINT_pjmp_tbl_s ST_create_file_pjtbl[];
static struct PINT_tran_tbl_s ST_create_file_trtbl[];

static PINT_sm_action open_create_file_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_file_inspect;
static struct PINT_pjmp_tbl_s ST_create_file_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_create_file_inspect_trtbl[];

static PINT_sm_action open_setup_fildes(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_setup_fildes;
static struct PINT_pjmp_tbl_s ST_setup_fildes_pjtbl[];
static struct PINT_tran_tbl_s ST_setup_fildes_trtbl[];
static struct PINT_state_s ST_fildes_getattr;
static struct PINT_pjmp_tbl_s ST_fildes_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_fildes_getattr_trtbl[];

static PINT_sm_action open_getattr_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_fildes_getattr_inspect;
static struct PINT_pjmp_tbl_s ST_fildes_getattr_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_fildes_getattr_inspect_trtbl[];
static struct PINT_state_s ST_file_truncate;
static struct PINT_pjmp_tbl_s ST_file_truncate_pjtbl[];
static struct PINT_tran_tbl_s ST_file_truncate_trtbl[];

static PINT_sm_action open_file_append_check(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_file_append_check;
static struct PINT_pjmp_tbl_s ST_file_append_check_pjtbl[];
static struct PINT_tran_tbl_s ST_file_append_check_trtbl[];
static struct PINT_state_s ST_file_append_getattr;
static struct PINT_pjmp_tbl_s ST_file_append_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_file_append_getattr_trtbl[];

static PINT_sm_action open_file_append_getattr_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_file_append_getattr_inspect;
static struct PINT_pjmp_tbl_s ST_file_append_getattr_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_file_append_getattr_inspect_trtbl[];
static struct PINT_state_s ST_file_append_readdir;
static struct PINT_pjmp_tbl_s ST_file_append_readdir_pjtbl[];
static struct PINT_tran_tbl_s ST_file_append_readdir_trtbl[];

static PINT_sm_action open_file_append_readdir_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_file_append_readdir_inspect;
static struct PINT_pjmp_tbl_s ST_file_append_readdir_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_file_append_readdir_inspect_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_aio_open_sm = {
	.name = "pvfs2_client_aio_open_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};

static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = OPEN_PDIR_GIVEN ,
	 .next_state = &ST_pdir_given },
	{ .return_value = OPEN_PDIR_NULL ,
	 .next_state = &ST_pdir_lookup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_pdir_given = {
	 .state_name = "pdir_given" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_pdir_lookup_given ,
	 .pjtbl = NULL ,
	 .trtbl = ST_pdir_given_trtbl 
};

static struct PINT_tran_tbl_s ST_pdir_given_trtbl[] = {
	{ .return_value = OPEN_RUN_LOOKUP_SM ,
	 .next_state = &ST_pdir_ref_lookup_rel },
	{ .return_value = OPEN_FIND_FILE ,
	 .next_state = &ST_file_lookup_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_pdir_lookup = {
	 .state_name = "pdir_lookup" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_pdir_lookup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_pdir_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_pdir_lookup_trtbl[] = {
	{ .return_value = OPEN_PDIR_RESOLVE_FAIL ,
	 .next_state = &ST_resolve_fail_file_lookup_setup },
	{ .return_value = OPEN_RUN_LOOKUP_SM ,
	 .next_state = &ST_pdir_ref_lookup_abs },
	{ .return_value = OPEN_FIND_FILE ,
	 .next_state = &ST_file_lookup_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
...
static struct PINT_state_s ST_pdir_ref_lookup_rel = {
	 .state_name = "pdir_ref_lookup_rel" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_pdir_ref_lookup_rel_trtbl 
};

static struct PINT_tran_tbl_s ST_pdir_ref_lookup_rel_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_pdir_ref_lookup_rel_setup_next }
};

static struct PINT_state_s ST_pdir_ref_lookup_abs = {
	 .state_name = "pdir_ref_lookup_abs" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_pdir_ref_lookup_abs_trtbl 
};

static struct PINT_tran_tbl_s ST_pdir_ref_lookup_abs_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_pdir_ref_lookup_abs_inspect }
};

static struct PINT_state_s ST_pdir_ref_lookup_rel_setup_next = {
	 .state_name = "pdir_ref_lookup_rel_setup_next" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_pdir_ref_lookup_rel_setup_next ,
	 .pjtbl = NULL ,
	 .trtbl = ST_pdir_ref_lookup_rel_setup_next_trtbl 
};
...
static struct PINT_state_s ST_pdir_ref_lookup_abs_inspect = {
	 .state_name = "pdir_ref_lookup_abs_inspect" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_pdir_ref_lookup_abs_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_pdir_ref_lookup_abs_inspect_trtbl 
};
...
static struct PINT_state_s ST_resolve_fail_file_lookup_setup = {
	 .state_name = "resolve_fail_file_lookup_setup" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_resolve_fail_file_lookup_abs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_resolve_fail_file_lookup_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_resolve_fail_file_lookup_setup_trtbl[] = {
	{ .return_value = OPEN_RUN_LOOKUP_SM ,
	 .next_state = &ST_resolve_fail_file_lookup },
	{ .return_value = -1 ,
	 .next_state = &ST_file_lookup_inspect }
};

static struct PINT_state_s ST_resolve_fail_file_lookup = {
	 .state_name = "resolve_fail_file_lookup" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_resolve_fail_file_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_resolve_fail_file_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_resolve_fail_file_lookup_inspect }
};

static struct PINT_state_s ST_resolve_fail_file_lookup_inspect = {
	 .state_name = "resolve_fail_file_lookup_inspect" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_resolve_fail_file_lookup_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_resolve_fail_file_lookup_inspect_trtbl 
};
...
static struct PINT_state_s ST_file_lookup_setup = {
	 .state_name = "file_lookup_setup" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_file_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_lookup_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_file_lookup_setup_trtbl[] = {
	{ .return_value = OPEN_RUN_LOOKUP_SM ,
	 .next_state = &ST_file_lookup },
	{ .return_value = -1 ,
	 .next_state = &ST_file_lookup_inspect }
};

static struct PINT_state_s ST_file_lookup = {
	 .state_name = "file_lookup" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_file_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_file_lookup_setup_next }
};

static struct PINT_state_s ST_file_lookup_setup_next = {
	 .state_name = "file_lookup_setup_next" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_file_lookup_setup_next ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_lookup_setup_next_trtbl 
};
...
static struct PINT_state_s ST_file_lookup_inspect = {
	 .state_name = "file_lookup_inspect" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_file_ref_lookup_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_lookup_inspect_trtbl 
};

static struct PINT_tran_tbl_s ST_file_lookup_inspect_trtbl[] = {
	{ .return_value = OPEN_CREATE_FILE ,
	 .next_state = &ST_create_file },
	{ .return_value = 0 ,
	 .next_state = &ST_setup_fildes },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_create_file = {
	 .state_name = "create_file" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_create_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_file_trtbl 
};

static struct PINT_tran_tbl_s ST_create_file_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_create_file_inspect }
};

static struct PINT_state_s ST_create_file_inspect = {
	 .state_name = "create_file_inspect" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_create_file_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_file_inspect_trtbl 
};
...
static struct PINT_state_s ST_setup_fildes = {
	 .state_name = "setup_fildes" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_setup_fildes ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setup_fildes_trtbl 
};

static struct PINT_tran_tbl_s ST_setup_fildes_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_fildes_getattr },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_fildes_getattr = {
	 .state_name = "fildes_getattr" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_fildes_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_fildes_getattr_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_fildes_getattr_inspect }
};

static struct PINT_state_s ST_fildes_getattr_inspect = {
	 .state_name = "fildes_getattr_inspect" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_getattr_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_fildes_getattr_inspect_trtbl 
};

static struct PINT_tran_tbl_s ST_fildes_getattr_inspect_trtbl[] = {
	{ .return_value = OPEN_TRUNCATE_FILE ,
	 .next_state = &ST_file_truncate },
	{ .return_value = -1 ,
	 .next_state = &ST_file_append_check }
};

static struct PINT_state_s ST_file_truncate = {
	 .state_name = "file_truncate" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_truncate_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_truncate_trtbl 
};
...
static struct PINT_state_s ST_file_append_check = {
	 .state_name = "file_append_check" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_file_append_check ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_append_check_trtbl 
};

static struct PINT_tran_tbl_s ST_file_append_check_trtbl[] = {
	{ .return_value = OPEN_FILE_APPEND ,
	 .next_state = &ST_file_append_getattr },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_file_append_getattr = {
	 .state_name = "file_append_getattr" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_append_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_file_append_getattr_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_file_append_getattr_inspect }
};

static struct PINT_state_s ST_file_append_getattr_inspect = {
	 .state_name = "file_append_getattr_inspect" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_file_append_getattr_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_append_getattr_inspect_trtbl 
};

static struct PINT_tran_tbl_s ST_file_append_getattr_inspect_trtbl[] = {
	{ .return_value = OPEN_FILE_APPEND ,
	 .next_state = &ST_file_append_readdir },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_file_append_readdir = {
	 .state_name = "file_append_readdir" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_readdir_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_append_readdir_trtbl 
};

static struct PINT_tran_tbl_s ST_file_append_readdir_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_file_append_readdir_inspect }
};

static struct PINT_state_s ST_file_append_readdir_inspect = {
	 .state_name = "file_append_readdir_inspect" ,
	 .parent_machine = &pvfs2_client_aio_open_sm ,
	 .flag = SM_RUN ,
	 .action.func = open_file_append_readdir_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_append_readdir_inspect_trtbl 
};
...
#ifndef WIN32
# 221 "src/client/usrint/aio-open.sm"
#endif
    ...
    void *user_ptr)
{
    ...
    if (fildes == NULL || directory == NULL || filename == NULL)
    {
    ...
    PVFS_hint hints)
{
    ...
    ret = PVFS_iaio_open(fildes, path, directory, filename, flags,
                         file_creation_param, mode, pdir, credential,
                         &op_id, hints, NULL);
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    memset(&sm_p->u.aio_open.lookup_resp, 0, sizeof(PVFS_sysresp_lookup));
    memset(&sm_p->u.aio_open.getattr_resp, 0, sizeof(PVFS_sysresp_getattr));
    memset(&sm_p->u.aio_open.create_resp, 0, sizeof(PVFS_sysresp_create));
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    else
    {
        ...
        PINT_init_sysint_credentials(lookup_frame->cred_p, sm_p->cred_p);
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    if (*(sm_p->u.aio_open.cur))
    {
        ...
        {
            free(lookup_frame);
            sm_p->u.aio_open.parent_ref.fs_id = sm_p->u.aio_open.lookup_resp.ref.fs_id;
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    if (js_p->error_code < 0)
    {
        ...
        PINT_init_sysint_credentials(create_frame->cred_p, sm_p->cred_p);
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    attr = getattr_frame->getattr.attr;
    ...
    if (sm_p->u.aio_open.flags & O_TRUNC)
    {
        ...
        PINT_init_sysint_credentials(trunc_frame->cred_p, sm_p->cred_p);
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    fildes_out->s->file_pointer = getattr_frame->getattr.size;
    free(getattr_frame);
    ...
    if (S_ISDIR(fildes_out->s->mode))
    {
        ...
        {        
            ...
            readdir_frame->readdir.readdir_resp = &sm_p->u.aio_open.readdir_resp;
            ...
            readdir_frame->readdir_state.dirent_array = &(sm_p->u.aio_open.readdir_resp.dirent_array);
            readdir_frame->readdir_state.dirent_outcount = &(sm_p->u.aio_open.readdir_resp.pvfs_dirent_outcount);
            readdir_frame->readdir_state.token = &(sm_p->u.aio_open.readdir_resp.token);
            readdir_frame->readdir_state.directory_version = &(sm_p->u.aio_open.readdir_resp.directory_version);

            readdir_frame->readdir_state.pos_token = fildes_out->s->token;
            readdir_frame->readdir.pos_token = fildes_out->s->token;
            readdir_frame->readdir_state.dirent_limit = dirent_no;
