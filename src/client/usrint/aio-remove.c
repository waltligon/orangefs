...
static struct PINT_state_s ST_file_ref_rel_lookup_setup;
static struct PINT_pjmp_tbl_s ST_file_ref_rel_lookup_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_file_ref_rel_lookup_setup_trtbl[];
static struct PINT_state_s ST_file_ref_rel_lookup;
static struct PINT_pjmp_tbl_s ST_file_ref_rel_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_file_ref_rel_lookup_trtbl[];

static PINT_sm_action remove_file_ref_rel_lookup_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_file_ref_rel_lookup_inspect;
static struct PINT_pjmp_tbl_s ST_file_ref_rel_lookup_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_file_ref_rel_lookup_inspect_trtbl[];

static PINT_sm_action remove_getattr_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_getattr_setup;
static struct PINT_pjmp_tbl_s ST_getattr_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_getattr_setup_trtbl[];
static struct PINT_state_s ST_getattr_sm_run;
static struct PINT_pjmp_tbl_s ST_getattr_sm_run_pjtbl[];
static struct PINT_tran_tbl_s ST_getattr_sm_run_trtbl[];

static PINT_sm_action remove_getattr_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_getattr_inspect;
static struct PINT_pjmp_tbl_s ST_getattr_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_getattr_inspect_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_aio_remove_sm = {
	.name = "pvfs2_client_aio_remove_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};

static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = REMOVE_PDIR_NULL ,
	 .next_state = &ST_parent_ref_abs_lookup_setup },
	{ .return_value = REMOVE_REF_FOUND ,
	 .next_state = &ST_file_ref_rel_lookup_setup },
	{ .return_value = -1 ,
...
static struct PINT_state_s ST_parent_ref_abs_lookup_setup = {
	 ...
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_parent_ref_abs_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_parent_ref_abs_lookup_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_parent_ref_abs_lookup_setup_trtbl[] = {
	{ .return_value = REMOVE_LOOKUP_SM ,
...
static struct PINT_state_s ST_parent_ref_abs_lookup_inspect = {
	 ...
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_parent_ref_abs_lookup_inspect ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_parent_ref_rel_lookup_setup = {
	 ...
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_parent_ref_rel_lookup_setup ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_parent_ref_rel_lookup_inspect = {
	 ...
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_parent_ref_rel_lookup_inspect ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_file_ref_rel_lookup_setup = {
	 .state_name = "file_ref_rel_lookup_setup" ,
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_file_ref_rel_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_ref_rel_lookup_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_file_ref_rel_lookup_setup_trtbl[] = {
	{ .return_value = REMOVE_REF_FOUND ,
	 .next_state = &ST_getattr_setup },
	{ .return_value = REMOVE_LOOKUP_SM ,
	 .next_state = &ST_file_ref_rel_lookup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_file_ref_rel_lookup = {
	 .state_name = "file_ref_rel_lookup" ,
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_ref_rel_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_file_ref_rel_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_file_ref_rel_lookup_inspect }
};

static struct PINT_state_s ST_file_ref_rel_lookup_inspect = {
	 .state_name = "file_ref_rel_lookup_inspect" ,
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_file_ref_rel_lookup_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_file_ref_rel_lookup_inspect_trtbl 
};
...
static struct PINT_state_s ST_getattr_setup = {
	 .state_name = "getattr_setup" ,
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_getattr_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_getattr_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_getattr_setup_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_getattr_sm_run },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_getattr_sm_run = {
	 .state_name = "getattr_sm_run" ,
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_getattr_sm_run_trtbl 
};

static struct PINT_tran_tbl_s ST_getattr_sm_run_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_getattr_inspect }
};

static struct PINT_state_s ST_getattr_inspect = {
	 .state_name = "getattr_inspect" ,
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_RUN ,
	 .action.func = remove_getattr_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_getattr_inspect_trtbl 
};
...
static struct PINT_state_s ST_sm_run = {
	 ...
	 .parent_machine = &pvfs2_client_aio_remove_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_remove_sm ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 150 "src/client/usrint/aio-remove.sm"
#endif
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    PINT_init_sysint_credentials(remove_frame->cred_p, sm_p->cred_p);
