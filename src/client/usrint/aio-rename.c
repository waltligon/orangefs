...
static struct PINT_state_s ST_oldref_abs_lookup_setup;
static struct PINT_pjmp_tbl_s ST_oldref_abs_lookup_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_oldref_abs_lookup_setup_trtbl[];
static struct PINT_state_s ST_oldref_abs_lookup;
static struct PINT_pjmp_tbl_s ST_oldref_abs_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_oldref_abs_lookup_trtbl[];

static PINT_sm_action rename_oldref_abs_lookup_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_oldref_abs_lookup_inspect;
static struct PINT_pjmp_tbl_s ST_oldref_abs_lookup_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_oldref_abs_lookup_inspect_trtbl[];

static PINT_sm_action rename_oldref_rel_lookup_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_oldref_rel_lookup_setup;
static struct PINT_pjmp_tbl_s ST_oldref_rel_lookup_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_oldref_rel_lookup_setup_trtbl[];
static struct PINT_state_s ST_oldref_rel_lookup;
static struct PINT_pjmp_tbl_s ST_oldref_rel_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_oldref_rel_lookup_trtbl[];

static PINT_sm_action rename_oldref_rel_lookup_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_oldref_rel_lookup_inspect;
static struct PINT_pjmp_tbl_s ST_oldref_rel_lookup_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_oldref_rel_lookup_inspect_trtbl[];

static PINT_sm_action rename_newref_lookup_init(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_newref_lookup_init;
static struct PINT_pjmp_tbl_s ST_newref_lookup_init_pjtbl[];
static struct PINT_tran_tbl_s ST_newref_lookup_init_trtbl[];

static PINT_sm_action rename_newref_abs_lookup_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_newref_abs_lookup_setup;
static struct PINT_pjmp_tbl_s ST_newref_abs_lookup_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_newref_abs_lookup_setup_trtbl[];
static struct PINT_state_s ST_newref_abs_lookup;
static struct PINT_pjmp_tbl_s ST_newref_abs_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_newref_abs_lookup_trtbl[];

static PINT_sm_action rename_newref_abs_lookup_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_newref_abs_lookup_inspect;
static struct PINT_pjmp_tbl_s ST_newref_abs_lookup_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_newref_abs_lookup_inspect_trtbl[];

static PINT_sm_action rename_newref_rel_lookup_setup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_newref_rel_lookup_setup;
static struct PINT_pjmp_tbl_s ST_newref_rel_lookup_setup_pjtbl[];
static struct PINT_tran_tbl_s ST_newref_rel_lookup_setup_trtbl[];
static struct PINT_state_s ST_newref_rel_lookup;
static struct PINT_pjmp_tbl_s ST_newref_rel_lookup_pjtbl[];
static struct PINT_tran_tbl_s ST_newref_rel_lookup_trtbl[];

static PINT_sm_action rename_newref_rel_lookup_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_newref_rel_lookup_inspect;
static struct PINT_pjmp_tbl_s ST_newref_rel_lookup_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_newref_rel_lookup_inspect_trtbl[];
...
static struct PINT_state_s ST_run_rename_sm;
static struct PINT_pjmp_tbl_s ST_run_rename_sm_pjtbl[];
static struct PINT_tran_tbl_s ST_run_rename_sm_trtbl[];

static PINT_sm_action rename_inspect_sm(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_inspect_rename_sm;
static struct PINT_pjmp_tbl_s ST_inspect_rename_sm_pjtbl[];
static struct PINT_tran_tbl_s ST_inspect_rename_sm_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_aio_rename_sm = {
	.name = "pvfs2_client_aio_rename_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};

static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = RENAME_PDIR_NULL ,
	 .next_state = &ST_oldref_abs_lookup_setup },
	{ .return_value = RENAME_DIR_REF_FOUND ,
	 .next_state = &ST_newref_lookup_init },
	{ .return_value = -1 ,
	 .next_state = &ST_oldref_rel_lookup_setup }
};

static struct PINT_state_s ST_oldref_abs_lookup_setup = {
	 .state_name = "oldref_abs_lookup_setup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_oldref_abs_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_oldref_abs_lookup_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_oldref_abs_lookup_setup_trtbl[] = {
	{ .return_value = RENAME_LOOKUP_SM ,
	 .next_state = &ST_oldref_abs_lookup },
	{ .return_value = RENAME_DIR_REF_FOUND ,
	 .next_state = &ST_newref_lookup_init },
	{ .return_value = -1 ,
...
static struct PINT_state_s ST_oldref_abs_lookup = {
	 .state_name = "oldref_abs_lookup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_oldref_abs_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_oldref_abs_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_oldref_abs_lookup_inspect }
};

static struct PINT_state_s ST_oldref_abs_lookup_inspect = {
	 .state_name = "oldref_abs_lookup_inspect" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_oldref_abs_lookup_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_oldref_abs_lookup_inspect_trtbl 
};
...
static struct PINT_state_s ST_oldref_rel_lookup_setup = {
	 .state_name = "oldref_rel_lookup_setup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_oldref_rel_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_oldref_rel_lookup_setup_trtbl 
};
...
static struct PINT_tran_tbl_s ST_oldref_rel_lookup_setup_trtbl[] = {
	{ .return_value = RENAME_DIR_REF_FOUND ,
	 .next_state = &ST_newref_lookup_init },
	{ .return_value = RENAME_LOOKUP_SM ,
	 .next_state = &ST_oldref_rel_lookup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_oldref_rel_lookup = {
	 .state_name = "oldref_rel_lookup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_oldref_rel_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_oldref_rel_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_oldref_rel_lookup_inspect }
};

static struct PINT_state_s ST_oldref_rel_lookup_inspect = {
	 .state_name = "oldref_rel_lookup_inspect" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_oldref_rel_lookup_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_oldref_rel_lookup_inspect_trtbl 
};
...
static struct PINT_state_s ST_newref_lookup_init = {
	 .state_name = "newref_lookup_init" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_newref_lookup_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_newref_lookup_init_trtbl 
};

static struct PINT_tran_tbl_s ST_newref_lookup_init_trtbl[] = {
	{ .return_value = RENAME_PDIR_NULL ,
	 .next_state = &ST_newref_abs_lookup_setup },
	{ .return_value = RENAME_DIR_REF_FOUND ,
	 .next_state = &ST_sm_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_newref_rel_lookup_setup }
};

static struct PINT_state_s ST_newref_abs_lookup_setup = {
	 .state_name = "newref_abs_lookup_setup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_newref_abs_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_newref_abs_lookup_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_newref_abs_lookup_setup_trtbl[] = {
	{ .return_value = RENAME_LOOKUP_SM ,
	 .next_state = &ST_newref_abs_lookup },
	{ .return_value = RENAME_DIR_REF_FOUND ,
	 .next_state = &ST_sm_setup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
...
static struct PINT_state_s ST_newref_abs_lookup = {
	 .state_name = "newref_abs_lookup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_newref_abs_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_newref_abs_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_newref_abs_lookup_inspect }
};

static struct PINT_state_s ST_newref_abs_lookup_inspect = {
	 .state_name = "newref_abs_lookup_inspect" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_newref_abs_lookup_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_newref_abs_lookup_inspect_trtbl 
};
...
static struct PINT_state_s ST_newref_rel_lookup_setup = {
	 .state_name = "newref_rel_lookup_setup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_newref_rel_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_newref_rel_lookup_setup_trtbl 
};
...
static struct PINT_tran_tbl_s ST_newref_rel_lookup_setup_trtbl[] = {
	{ .return_value = RENAME_DIR_REF_FOUND ,
	 .next_state = &ST_sm_setup },
	{ .return_value = RENAME_LOOKUP_SM ,
	 .next_state = &ST_newref_rel_lookup },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_newref_rel_lookup = {
	 .state_name = "newref_rel_lookup" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_lookup_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_newref_rel_lookup_trtbl 
};

static struct PINT_tran_tbl_s ST_newref_rel_lookup_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_newref_rel_lookup_inspect }
};

static struct PINT_state_s ST_newref_rel_lookup_inspect = {
	 .state_name = "newref_rel_lookup_inspect" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_newref_rel_lookup_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_newref_rel_lookup_inspect_trtbl 
};
...
static struct PINT_tran_tbl_s ST_sm_setup_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_run_rename_sm },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_run_rename_sm = {
	 .state_name = "run_rename_sm" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_rename_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_run_rename_sm_trtbl 
};

static struct PINT_tran_tbl_s ST_run_rename_sm_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_inspect_rename_sm }
};

static struct PINT_state_s ST_inspect_rename_sm = {
	 .state_name = "inspect_rename_sm" ,
	 .parent_machine = &pvfs2_client_aio_rename_sm ,
	 .flag = SM_RUN ,
	 .action.func = rename_inspect_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_rename_sm_trtbl 
};
...
#ifndef WIN32
# 159 "src/client/usrint/aio-rename.sm"
#endif
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    PINT_init_sysint_credentials(rename_frame->cred_p, sm_p->cred_p);
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    struct PINT_client_sm *rename_frame = (PINT_client_sm *)PINT_sm_pop_frame(
                                smcb, &frame_id,
                                &js_p->error_code, &frames_remaining);
    js_p->error_code = rename_frame->error_code;
    free(rename_frame);
