...
struct PINT_state_machine_s pvfs2_client_aio_symlink_sm = {
	.name = "pvfs2_client_aio_symlink_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_aio_symlink_sm ,
	 .flag = SM_RUN ,
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = SYMLINK_PDIR_NULL ,
	 .next_state = &ST_parent_ref_abs_lookup_setup },
	{ .return_value = SYMLINK_REF_FOUND ,
...
static struct PINT_state_s ST_parent_ref_abs_lookup_setup = {
	 ...
	 .parent_machine = &pvfs2_client_aio_symlink_sm ,
	 .flag = SM_RUN ,
	 .action.func = symlink_parent_ref_abs_lookup_setup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_parent_ref_abs_lookup_setup_trtbl 
};

static struct PINT_tran_tbl_s ST_parent_ref_abs_lookup_setup_trtbl[] = {
	{ .return_value = SYMLINK_LOOKUP_SM ,
...
static struct PINT_state_s ST_parent_ref_abs_lookup_inspect = {
	 ...
	 .parent_machine = &pvfs2_client_aio_symlink_sm ,
	 .flag = SM_RUN ,
	 .action.func = symlink_parent_ref_abs_lookup_inspect ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_parent_ref_rel_lookup_setup = {
	 ...
	 .parent_machine = &pvfs2_client_aio_symlink_sm ,
	 .flag = SM_RUN ,
	 .action.func = symlink_parent_ref_rel_lookup_setup ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_parent_ref_rel_lookup_inspect = {
	 ...
	 .parent_machine = &pvfs2_client_aio_symlink_sm ,
	 .flag = SM_RUN ,
	 .action.func = symlink_parent_ref_rel_lookup_inspect ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_sm_run = {
	 ...
	 .parent_machine = &pvfs2_client_aio_symlink_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_symlink_sm ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_sm_inspect = {
	 ...
	 .parent_machine = &pvfs2_client_aio_symlink_sm ,
	 .flag = SM_RUN ,
	 .action.func = symlink_sm_inspect ,
	 .pjtbl = NULL ,
...
#ifndef WIN32
# 108 "src/client/usrint/aio-symlink.sm"
#endif
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    PINT_init_sysint_credentials(symlink_frame->cred_p, sm_p->cred_p);
