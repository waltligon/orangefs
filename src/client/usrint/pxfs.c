                     ...
                     pxfs_cb cb, void *cdat, ...)
{
    ...
    rc = split_pathname(newpath, &(open_acb->u.open.directory),
...
extern int pxfs_unlink(const char *path, pxfs_cb cb, void *cdat)
{
    ...
    rc = split_pathname(newpath, &unlink_acb->u.remove.directory,
                       ...
                       pxfs_cb cb, void *cdat)
{
    ...
    rc = split_pathname(abs_oldpath, &(rename_acb->u.rename.olddir),
    ...
    rc = split_pathname(abs_newpath, &(rename_acb->u.rename.newdir),
...
extern int pxfs_mkdir(const char *path, mode_t mode, pxfs_cb cb, void *cdat)
{
    ...
    rc = split_pathname(newpath, &mkdir_acb->u.mkdir.directory,
...
extern int pxfs_rmdir(const char *path, pxfs_cb cb, void *cdat)
{
    ...
    rc = split_pathname(newpath, &rmdir_acb->u.remove.directory,
                        ...
                        pxfs_cb cb, void *cdat)
{
    ...
    rc = split_pathname(abspath, &(symlink_acb->u.symlink.new_directory),
