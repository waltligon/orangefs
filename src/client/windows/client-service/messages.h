...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "OrangeFS-Client-Provider" event count 2
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = cd75d1d2-a19b-4c81-a8a9-629fcd2fd998
EXTERN_C __declspec(selectany) const GUID PROVIDER_GUID = {0xcd75d1d2, 0xa19b, 0x4c81, {0xa8, 0xa9, 0x62, 0x9f, 0xcd, 0x2f, 0xd9, 0x98}};
...
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR INFO_EVENT = {0x1, 0x0, 0x9, 0x4, 0x0, 0x0, 0x8000000000000000};
#define INFO_EVENT_value 0x1
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ERROR_EVENT = {0x2, 0x0, 0x9, 0x2, 0x0, 0x0, 0x8000000000000000};
...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG OrangeFS_Client_ProviderEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG OrangeFS_Client_ProviderKeywords[2] = {0x8000000000000000, 0x8000000000000000};
EXTERN_C __declspec(selectany) const unsigned char OrangeFS_Client_ProviderLevels[2] = {4, 2};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT PROVIDER_GUID_Context = {0, (ULONG_PTR)PROVIDER_GUID_Traits, 0, 0, 0, 0, 0, 0, 2, OrangeFS_Client_ProviderEnableBits, OrangeFS_Client_ProviderKeywords, OrangeFS_Client_ProviderLevels};

//
// Provider REGHANDLE
//
#define OrangeFS_Client_ProviderHandle (PROVIDER_GUID_Context.RegistrationHandle)
...
//
#ifndef EventRegisterOrangeFS_Client_Provider
#define EventRegisterOrangeFS_Client_Provider() McGenEventRegister(&PROVIDER_GUID, McGenControlCallbackV2, &PROVIDER_GUID_Context, &OrangeFS_Client_ProviderHandle)
#endif
...
//
#ifndef EventRegisterByGuidOrangeFS_Client_Provider
#define EventRegisterByGuidOrangeFS_Client_Provider(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &PROVIDER_GUID_Context, &OrangeFS_Client_ProviderHandle)
#endif
...
//
#ifndef EventUnregisterOrangeFS_Client_Provider
#define EventUnregisterOrangeFS_Client_Provider() McGenEventUnregister(&OrangeFS_Client_ProviderHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_OrangeFS_Client_Provider));
// - Caller registers the provider, e.g. EventRegisterOrangeFS_Client_Provider_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterOrangeFS_Client_Provider_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_OrangeFS_Client_Provider {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use OrangeFS_Client_ProviderHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_OrangeFS_Client_Provider;

#define EventRegisterOrangeFS_Client_Provider_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_OrangeFS_Client_Provider_, MCGEN_EVENTREGISTER)(&PROVIDER_GUID, pContext)
#define EventRegisterByGuidOrangeFS_Client_Provider_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_OrangeFS_Client_Provider_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterOrangeFS_Client_Provider_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define OrangeFS_Client_ProviderHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_OrangeFS_Client_Provider_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_OrangeFS_Client_Provider* pContext)
{
    ...
    pContext->Context.EnableKeyWords = OrangeFS_Client_ProviderKeywords;
    pContext->Context.EnableLevel = OrangeFS_Client_ProviderLevels;
...
FORCEINLINE
_Ret_ McGenContext_OrangeFS_Client_Provider*
_mcgen_CheckContextType_OrangeFS_Client_Provider(_In_ McGenContext_OrangeFS_Client_Provider* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "INFO_EVENT"
//
#define EventEnabledINFO_EVENT() _mcgen_EVENT_BIT_SET(OrangeFS_Client_ProviderEnableBits, 0)
#define EventEnabledINFO_EVENT_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_OrangeFS_Client_Provider(pContext)->EnableBits, 0)

//
// Event write macros for event "INFO_EVENT"
//
#define EventWriteINFO_EVENT(MessageData) \
        MCGEN_EVENT_ENABLED(INFO_EVENT) \
        ? _mcgen_TEMPLATE_FOR_INFO_EVENT(&PROVIDER_GUID_Context, &INFO_EVENT, MessageData) : 0
#define EventWriteINFO_EVENT_AssumeEnabled(MessageData) \
        _mcgen_TEMPLATE_FOR_INFO_EVENT(&PROVIDER_GUID_Context, &INFO_EVENT, MessageData)
#define EventWriteINFO_EVENT_ForContext(pContext, MessageData) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, INFO_EVENT) \
        ? _mcgen_TEMPLATE_FOR_INFO_EVENT(&(pContext)->Context, &INFO_EVENT, MessageData) : 0
#define EventWriteINFO_EVENT_ForContextAssumeEnabled(pContext, MessageData) \
        _mcgen_TEMPLATE_FOR_INFO_EVENT(&_mcgen_CheckContextType_OrangeFS_Client_Provider(pContext)->Context, &INFO_EVENT, MessageData)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_INFO_EVENT _mcgen_PASTE2(McTemplateU0s_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "ERROR_EVENT"
//
#define EventEnabledERROR_EVENT() _mcgen_EVENT_BIT_SET(OrangeFS_Client_ProviderEnableBits, 1)
#define EventEnabledERROR_EVENT_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_OrangeFS_Client_Provider(pContext)->EnableBits, 1)

//
// Event write macros for event "ERROR_EVENT"
//
#define EventWriteERROR_EVENT(MessageData) \
        MCGEN_EVENT_ENABLED(ERROR_EVENT) \
        ? _mcgen_TEMPLATE_FOR_ERROR_EVENT(&PROVIDER_GUID_Context, &ERROR_EVENT, MessageData) : 0
#define EventWriteERROR_EVENT_AssumeEnabled(MessageData) \
        _mcgen_TEMPLATE_FOR_ERROR_EVENT(&PROVIDER_GUID_Context, &ERROR_EVENT, MessageData)
#define EventWriteERROR_EVENT_ForContext(pContext, MessageData) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ERROR_EVENT) \
        ? _mcgen_TEMPLATE_FOR_ERROR_EVENT(&(pContext)->Context, &ERROR_EVENT, MessageData) : 0
#define EventWriteERROR_EVENT_ForContextAssumeEnabled(pContext, MessageData) \
        _mcgen_TEMPLATE_FOR_ERROR_EVENT(&_mcgen_CheckContextType_OrangeFS_Client_Provider(pContext)->Context, &ERROR_EVENT, MessageData)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ERROR_EVENT _mcgen_PASTE2(McTemplateU0s_, MCGEN_EVENTWRITETRANSFER)
...
#define MSG_Event_Info                       0x00000001L
#define MSG_Event_Error                      0x00000002L
