...
{
	char* method_name;
	int (*BMI_meth_initialize)(method_addr_p, bmi_flag_t, bmi_flag_t);
	int (*BMI_meth_finalize)(void);
	int (*BMI_meth_set_info)(int, void*);
	int (*BMI_meth_get_info)(int, void*);
	void* (*BMI_meth_memalloc)(bmi_size_t, bmi_flag_t);
	int (*BMI_meth_memfree)(void*, bmi_size_t, bmi_flag_t);
	int (*BMI_meth_post_send)(bmi_op_id_t*, method_addr_p, void*,
		bmi_size_t, bmi_flag_t, bmi_msg_tag_t, void*);
	int (*BMI_meth_post_sendunexpected)(bmi_op_id_t*, method_addr_p, void*,
		bmi_size_t, bmi_flag_t, bmi_msg_tag_t, void*);
	...
	int (*BMI_meth_post_recv_list)( bmi_op_id_t*, method_addr_p,
		void**, bmi_size_t*, int, bmi_size_t, bmi_size_t*, bmi_flag_t,
		bmi_msg_tag_t, void*); 
	int (*BMI_meth_post_sendunexpected_list)(bmi_op_id_t*,
		method_addr_p, void**, bmi_size_t*, int, bmi_size_t,
		bmi_flag_t, bmi_msg_tag_t, void*);
};
...
char* string_key(const char* key, const char* id_string);
