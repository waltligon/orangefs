 ...
 *
 * $Id: mem.c,v 1.7.10.1 2006-07-21 17:40:27 kunkel Exp $
 */
 ...
 */
static memcache_entry_t *memcache_add(
 ...
 */
void *memcache_init(
    void (*mem_register) (memcache_entry_t *),
