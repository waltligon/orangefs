...
/*
static void debugPrintList(dbpf_op_queue_t *  op_queue)
{
 ...
 * 4) return the id
 */
TROVE_op_id dbpf_queued_op_queue(dbpf_queued_op_t *q_op_p, dbpf_op_queue_t* queue)
{
 ...
 * already held
 */
TROVE_op_id dbpf_queued_op_queue_nolock(dbpf_queued_op_t *q_op_p, dbpf_op_queue_t* queue)
{
    TROVE_op_id tmp_id = 0;
