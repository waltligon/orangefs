...
void dbpf_op_queue_add(dbpf_op_queue_p op_queue, dbpf_queued_op_t *dbpf_op);
...
int dbpf_queued_op_try_get(TROVE_op_id id, dbpf_queued_op_t **q_op_pp);
...
int dbpf_queue_or_service(struct dbpf_op *op_p,
...
int dbpf_queued_op_sync_coalesce_db_ops(dbpf_queued_op_t *qop_p);

int dbpf_queued_op_sync_coalesce_dequeue(dbpf_queued_op_t *qop_p);

int dbpf_queued_op_sync_coalesce_enqueue(dbpf_queued_op_t *qop_p);
