 ...
 */
static inline void dbpf_queued_op_init(
 ...
 */
static inline void dbpf_queued_op_queue(
	struct dbpf_queued_op *q_op_p);
 ...
 */
static inline void dbpf_queued_op_dequeue(
	struct dbpf_queued_op *q_op_p);
 ...
 * again.
 */
static inline void dbpf_queued_op_touch(
	struct dbpf_queued_op *q_op_p);
