...
static int pvfs2_devflow_open(struct inode *inode, struct file *file)
{
...
static ssize_t pvfs2_devflow_read(struct file *file, char *buf,
...
static ssize_t pvfs2_devflow_write(struct file *file, const char *buf,
                                   size_t count, loff_t *offset)
{
...
*/
static int pvfs2_devflow_release(struct inode *inode, struct file *file)
{
