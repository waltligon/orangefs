...
static void pvfs2_read_inode(struct inode *inode)
{
...
static void pvfs2_write_inode(struct inode *inode, int force_sync)
{
...
static void pvfs2_put_inode(struct inode *inode)
{
...
static int pvfs2_statfs(struct super_block *sb, struct kstatfs *buf)
{
...
static int pvfs2_remount(struct super_block *sb, int *flags, char *data)
{
