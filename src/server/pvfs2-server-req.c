...
extern struct PINT_server_req_params pvfs2_mgmt_migrate_params;
extern struct PINT_server_req_params pvfs2_migrate_create_params;
...
struct PINT_server_req_entry PINT_server_req_table[] =
{
    ...
    /* 43 */ {PVFS_SERV_MGMT_MIGRATE, &pvfs2_mgmt_migrate_params},
    /* 44 */ {PVFS_SERV_MIGRATE_CREATE, &pvfs2_migrate_create_params},
};
