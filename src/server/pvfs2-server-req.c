...
extern struct PINT_server_req_params pvfs2_revoke_cap_params;
extern struct PINT_server_req_params pvfs2_tree_revoke_cap_params;
...
struct PINT_server_req_entry PINT_server_req_table[] =
{
    ...
    /* 50 */ {PVFS_SERV_REVOKE_CAP, &pvfs2_revoke_cap_params},
    /* 51 */ {PVFS_SERV_TREE_REVOKE_CAP, &pvfs2_tree_revoke_cap_params}
#ifdef ENABLE_SECURITY_CERT    
