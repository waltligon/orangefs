...
extern struct PINT_server_req_params pvfs2_get_value_params;
extern struct PINT_server_req_params pvfs2_get_path_params;
...
struct PINT_server_req_entry PINT_server_req_table[] =
{
    ...
    /* 41 */ {PVFS_SERV_GETVALUE, &pvfs2_get_value_params},
    /* 42 */ {PVFS_SERV_GETPATH, &pvfs2_get_path_params},
};
