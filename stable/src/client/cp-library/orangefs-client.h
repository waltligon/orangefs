...
#define orangefs_read(fs_id, \
					  cred, \
					  fs_path, \
					  buffer, \
					  buffer_len, \
					  offset, \
					  write_len)  orangefs_io(fs_id, cred, ORANGEFS_IO_READ, fs_path, buffer, buffer_len, offset, write_len)


#define orangefs_write(fs_id, \
					   cred, \
					   fs_path, \
					   buffer, \
					   buffer_len, \
					   offset, \
					   write_len)  orangefs_io(fs_id, cred, ORANGEFS_IO_WRITE, fs_path, buffer, buffer_len, offset, write_len)
