    ...
    int testcase)
{
    ...
    case 1:
        ...
        break;
    case 2:
        ret = PVFS_sys_lookup(fs_id, "invalid_perms", &credentials,
                              &resp_lk, PVFS2_LOOKUP_LINK_NO_FOLLOW);
        if (ret < 0)
        {
            debug_printf("test_pvfs_datatype_hvector: lookup failed "
    ...
    ret =
        PVFS_sys_read(resp_lk.ref, req_io, file_req_offset, io_buffer, req_mem,
                      &credentials, &resp_io);
/*     finalize_sysint(); */
    return ret;

}
static int test_size_after_write(
    void)
{
    PVFS_credentials credentials;
    PVFS_sysresp_lookup resp_lk;
    ...
    if ((ret =
         PVFS_sys_getattr(resp_lk.ref, attrmask, &credentials, &resp)) < 0)
        return ret;
    ...
    ret =
        PVFS_sys_write(resp_lk.ref, req_io, file_req_offset, io_buffer, req_mem,
                       &credentials, &resp_io);
    if (ret < 0)
    {
...
static int test_read_sparse_files(
    void)
{
    PVFS_credentials credentials;
    PVFS_sysresp_lookup resp_lk;
    ...
    int testcase)
{
    ...
    if ((ret =
         PVFS_sys_getattr(resp_look.ref, attrmask, &credentials, &resp)) < 0)
        return ret;
    ...
    int testcase)
{
    ...
    case 0:
        ret =
            PVFS_sys_read(resp_lookup.ref, req_io, file_req_offset, io_buffer,
    ...
    case 1:
        ...
        ret =
            PVFS_sys_write(resp_lookup.ref, req_io, file_req_offset, io_buffer,
                           req_mem, &credentials, &resp_io);
        break;
...
static int test_remove_nonempty_dir(
    int testcase)
{
    PVFS_credentials credentials;
    PVFS_sysresp_lookup resp_look;
