    ...
    void)
{
    ...
    assert(len_arrayS != NULL && len_arrayC != NULL && off_arrayS != NULL
           && off_arrayC != NULL);
    ...
    PINT_REQUEST_STATE_SET_FINAL(file_state_server,
                                 PINT_REQUEST_TOTAL_BYTES(mem_req));
...
*/
    do
    {
        ...
        /* process request */
        retval =
            PINT_process_request(file_state, mem_state, &rf1, &seg1,
                                 PINT_CLIENT);
...
*/
    ...
    do
    {
        ...
        /* process request */
        retval =
            PINT_process_request(file_state_server, NULL, &rf1, &seg1,
                                 PINT_SERVER);
