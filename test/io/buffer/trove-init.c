    ...
    TROVE_context_id * context_p)
{
    ...
    ret = trove_bstream_write_list(coll_id, file_handle, mem_offset_array, mem_size_array, mem_count, stream_offset_array, stream_size_array, stream_count, &output_size, 0,    /* flags */
                                   NULL,        /* vtag */
