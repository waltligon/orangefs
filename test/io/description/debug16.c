...
int main(int argc, char **argv)
{
   ...
   /* Turn on debugging */
	...
	printf("\n************************************\n");
	printf("One request in CLIENT mode size 24*4 strided -16 server 0 of 4\n");
   ...
   /* Turn on debugging */
	...
	printf("\n************************************\n");
	printf("One request in SERVER mode size 24*4 strided -16 server 0 of 4\n");
	printf("Simple stripe, default stripe size (64K)\n");
	printf("Offset 0M, file size 6000, no extend flag\n");
	printf("MemReq size 96 coniguous\n");
	printf("\n************************************\n");
