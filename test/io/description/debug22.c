    ...
    void)
{
    ...
    PVFS_Request_vector(64, 3 * 1024, 4 * 1024, PVFS_BYTE, &r);
    ...
    printf("Vector request, 3K block 4K stride, 64 blocks\n");
    ...
    do
    {
        ...
        {
            fprintf(stderr,
                    "IEEE! reporting more work to do when I should really be done...\n");
        }
    ...
    do
    {
         ...
         * data that I should find here
         */
        retval = PINT_process_request(rs3, NULL, &rf3, &seg1, PINT_CLIENT);
    ...
    do
    {
         ...
         * data that I should find here
         */
        retval = PINT_process_request(rs4, NULL, &rf4, &seg1, PINT_CLIENT);
